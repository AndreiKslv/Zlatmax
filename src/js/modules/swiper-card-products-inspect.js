...
function swiperCardProductsInspect() {
	const productsData = [
		{
			id: 1,
			title: "Чёрный",
	...
	const sortedCardsByAlike = data.sort((a, b) => a.price - b.price).slice(0, 8)
	const sortedCardsByRecommends = data.sort((a, b) => b.rating - a.rating).slice(0, 8)

	
	const swiperAlike = document.querySelector('.swiper-alike')
	const swiperRecommends = document.querySelector('.swiper-recommends')
	

	if (swiperAlike) {
		const swiperAlikeItems = swiperAlike.querySelectorAll('.common-card-swiper__item')
		renderProducts(sortedCardsByAlike, swiperAlikeItems)
	}

	if (swiperRecommends) {
		const swiperRecommendsItems = swiperRecommends.querySelectorAll('.common-card-swiper__item')
		renderProducts(sortedCardsByRecommends, swiperRecommendsItems)
	}
	...
	function renderProducts(arr, coll) {
		arr.forEach(function (item, index) {
			...
			<article class="filter__grid-item common-card">
				...
				<div class="common-card__wrapper">
					...
					<div class="common-card__price-info">
						<div class="common-card__price">
							<a class="common-card__price-link" href="#!">
				...
				<a class="button button--mobile" href="#!">
					В корзину
...
export default swiperCardProductsInspect